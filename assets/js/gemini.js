            ...
            setup: {
                ...
                generationConfig: {
                    ...
                    speechConfig: {
                        ...
                        languageCode: "en-US", //docs: https://ai.google.dev/api/generate-content#SpeechConfig, https://ai.google.dev/gemini-api/docs/live-guide#change-voice-and-language
                    },
                },
                systemInstruction: {
...
export const bufferAudioChunk = async (base64Audio) => {
    try {
        ...
        console.log("Sent audio fragment to Gemini Live API");
    } catch (error) {
...
export const createResponse = async () => {
    try {
        ...
        // end activity, so that model can respond
